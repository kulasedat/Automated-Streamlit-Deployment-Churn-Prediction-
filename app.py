...
models_name = st.sidebar.selectbox("Select Model for ML", ("XGBoost", "Random Forest"))
params = dict()
...
def get_classifier(classifier_name, params):
    ...
    if classifier_name == "XGBoost":
        clf_model = XGBClassifier(n_estimators=params["n_estimators"], sub_sample=params["sub_sample"],
